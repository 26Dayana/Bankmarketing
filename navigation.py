...
def make_sidebar():
    with st.sidebar:
        ...
        if st.session_state.get("logged_in", False):
            st.page_link("pages/page2.py", label="Home", icon="🏠")
            st.page_link("pages/page1.py", label="Predict", icon="📝")
            st.page_link("pages/page3.py", label="Analysis", icon="📶")
            st.page_link("pages/page4.py", label="Contact Us", icon="☎️")
